      ...
      >
        <div className="w-full max-w-6xl rounded-lg p-2">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr
                ...
                className="border-b-4 border-gray-200 dark:border-gray-200"
              >
              ...
              {emptyRows > 0 &&
                Array.from({ length: emptyRows }).map((_, i) => (
                  <tr key={`empty-${i}`}>
                    <td
                      colSpan={4}
                      className="text-center text-gray-500 dark:text-gray-400 h-16"
                    >
          ...
          <div className="mt-4 flex justify-between items-center text-sm text-gray-500 dark:text-gray-400">
            <span>
              Mostrando {filteredProducts.length === 0 ? 0 : startIndex + 1} a{" "}
            ...
            <div className="flex items-center gap-1">
              ...
              {Array.from({ length: totalPages }, (_, i) => (
                <button
                  ...
                  style={{
                    backgroundColor:
                      page === i + 1 ? colors.primary : "transparent",
